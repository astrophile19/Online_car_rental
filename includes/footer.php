        ...
        <div class="col-md-6 col-md-push-6 text-right">
          <div class="footer_widget">
            ...
            <ul>
              ...
              <li><a href="https://www.google-plus.com"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a></li>
              <li><a href="https://www.instagram.com"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2019 AUTOMAX CAR RENTAL. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </div>
