...
<title>AUTOMAX CAR RENTAL</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find the Car of your Choice</h1>
            <p>From our wide range of cars to choose </p>
...
<input type="hidden" name="cmd" value="mybookings">
<input type="hidden" name="upload" value="1">
<input type="hidden" name="business" value="automax@test.com">
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>The automobile industry today is the most lucrative industry;Automax Car Rental offers you the perfect opportunity to see rent a
      car of your choice whether it be new or old.So,what are you waiting for?!?</p>
    </div>
    <div class="row"> 
